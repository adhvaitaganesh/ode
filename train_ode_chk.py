...
CHECKPOINT_FILE = "ode_checkpoint.pt"
...
# The weight_decay acts as a rubber band, pulling the curves smooth.
...
for i in range(start_step, STEPS):
    ...
    if i % 100 == 0:
        ...
        print(f"Step {i} | Checkpoint saved.")
...
print("SUCCESS! Saved 'predicted_trajectory_adjoint.csv'")
