...
traj = pd.read_csv("predicted_trajectory_adjoint_10k.csv", index_col=0)
...
plt.tight_layout()
plt.savefig("Final_Results_Plot_10k.png", dpi=300)
print("Saved 'Final_Results_Plot_10k.png'. check it now!")
